    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    readorganizer.models.ChannelURLField(max_length=2048, unique=True),
                ),
                (
                    "channel_type",
                    models.CharField(
